...
class hotdeals extends CI_Controller {
    ...
    public function index() {
		...
		$data["master_title"] = "Hot Deals Lists";   // Please enter the title of page......
		$data["master_body"] = "index";   // Please enter the body of page......
		$data['userdata'] = $this->session->userdata('userdata');
		$this->load->theme('hotdeals', $data);  // Loading theme		
    }
	...
	public function add_new() {	
		...
		if($reqData){			
			...
			$this->db->insert('gp_hotdeals',$reqData);
		...
		$data["master_title"] = "Add New Hot Deal";   // Please enter the title of page......
	...
	public function edit($id=null){
		...
		if($this->input->post()){
			...
			$this->db->where('id',$id);
			$this->db->update('gp_hotdeals',$this->input->post());
			redirect(BASEURL.'/hotdeals');
		}
