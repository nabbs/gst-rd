...
//Date picker
    $('#hajj_starting_date,#hajj_end_date').datepicker({
      autoclose: true
    });
...
$("#open_gallery").on('click',function(){
	...
	$("#open-gallery-box").on("hidden.bs.modal", function () {
		...
		$(".pic").html('<img class="img-responsive image_selected" src="/../assets/files/'+result.image_name+'" alt="Photo" data-src="/../assets/files/'+result.image_name+'"><input type="hidden" id="package_logo" name="package_logo" value="'+result.image_name+'">');
		 }
		}
		});
	});
