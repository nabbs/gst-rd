...
<div class="page-content">
    ...
    <div class="row">
       <div class="col-sm-8 col-xs-8">
        ...
        <div class="col-sm-4">
          <span style="color:green; line-height:34px"><?php 
          // echo $msg =    $this->session->flashdata('msg'); ?></span>
        </div>
        </div>   
			...
			<div class="gp_empty"></div>
                <table class="table table-striped table-bordered table-hover table-responsive" >
                    ...
                    <tbody class="text-center">
                        <?php
						if(!empty($post_companies)){
              
                        foreach ($post_companies as $key => $val) {
						 $company_name = get_company_details_user_id($val['user_id']);
