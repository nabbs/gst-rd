    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="box box-primary">
            ...
            <form role="form" action="/admin/hotdeals/add_new" method="post">
              <div class="box-body">
              ...
              <div class="col-xs-6">
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="price" name="after_from_text_two" placeholder="enter two text" value="" required>
                </div>
