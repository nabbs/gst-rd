...
<!--  --------------------------------------------USER DETAILS STARTS--------------------------------------------- -->	
<form method='POST' id="form_update_template_edit" name="form_update_template_edit" action='<?php echo BASEURL.'/template/create_list/';?>'   >
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
					 <label><strong>List name</strong></label>
	                  <input type="text" name="list_name" id="template_name" class="form-control"  value="<?php  if(!empty($template_data)) echo $template_data['list_name'] ;   ?>" / >
					</div>
				  </div>
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
   ...
   <div class="form-group">
                  ...
                  <select class="form-control select2" multiple name='subscriber_mail[]' required>
                    ...
                    <option value='<?php echo $val['email'];?>'><?php echo $val['email']; ?></option>
					<?php } ?>
