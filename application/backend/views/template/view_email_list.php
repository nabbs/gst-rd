...
<div class="page-content">
  ...
  <a href="<?php echo base_url(); ?><?php echo $this->router->class; ?>/create_list" class="btn btn-primary">
		Create Mailing List	
		</a>
                ...
                <table class="table table-striped table-bordered table-hover table-responsive" id="sample_1">
                    <thead >
                        <tr >
                            ...
                            <th class="text-center">Email subscriber</th>
                   ...
                   //print_r($mail_list);
                        $srno=1; 
							...
							<tr role="row" class="even text-center">
								...
								<td><?php echo $val['subscritption_emails']; ?></td>
								
								<td> 
								 <?php //if($val['status']==1) { ?>
                                  
								  <a  href='<?php echo BASEURL; ?>/template/edit_email_list/<?php echo $val['id']; ?>'style='color:red;'><i class="fa fa-edit " title='edit'></i></a>
								  <a  href='<?php echo BASEURL; ?>/template/remove_email_list/<?php echo $val['id']; ?>'style='color:red;'><i class="fa fa-trash " title='Remove'></i></a>
                                  <?php //} ?>
								 </td>
							</tr>
						<?php } ?>	
