    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="box box-primary">
            ...
            <form role="form" action="/admin/topdestinations/edit/<?php echo $results['id']; ?>" method="post">
              <div class="box-body">
              ...
              <div class="col-xs-6">
               ...
               <div class="form-group">
                  ...
                  <input type="checkbox" name='popular' value='1' <?php if($results['popular']==1){ echo 'checked'; } ?>>
                </div>
