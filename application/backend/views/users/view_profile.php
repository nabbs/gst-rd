...
<div class="page-content">
  ...
  User  Joining Date: <b><?php echo date('m-d-Y',strtotime($user_details['created']));?></b>       </div>
	</div-->
...
<!--input type="hidden" name="update_pro" value="update_profile" /-->
 ...
 <div class="col-md-4 col-sm-4 col-xs-12">
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
 	...
 	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="form-group" >			
			<button type="submit" name="submit_profile" value="update_profile" class="btn green"><i class="fa fa-send"></i> Confirm Details</button>
