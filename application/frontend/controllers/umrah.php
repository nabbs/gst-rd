...
ob_start();
	class umrah  extends CI_Controller {
		...
		$data['get_hajj'] = $this->umrah_model->all();
		
		if(@$_GET){
		$data['get_hajj'] = $this->umrah_model->get_search(@$_GET);
...
if($conditions){
  ...
  $this->db->where("room_type BETWEEN ".$conditions['rangesValues'][0] ." AND ". $conditions['rangesValues'][1]);
}
      ...
      <div class="hajj_results">
       <div class="panel panel-default '. $class .'">
        ...
        <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4 hajj_second_section">
          ...
          <li class="hajj-royal-scot"><span>'.$val['makkah_hotel_name']. '</span>';
          ...
          <li class="hajj-royal-scot-medina"><span>'.$val['medina_hotel_name']. '</span> ';
          ...
          $data .='<div class="col-md-4 col-sm-4 col-xs-4 col-lg-4 hajj_third_section">
           <ul>';
		   if($_POST['medina_val'] && !$_POST['makkah_val'] && ($val['medina_room_type_quad_value']!= '' || $val['medina_room_type_triple_value']!= '' || $val['medina_room_type_double_value']!= '')){
			   $data .= '<li>';
          if($val['medina_room_type_quad_value']!= ''){
            $data .=  '<span class="room_type_heading">Quad</span>';
          } 
          if($val['medina_room_type_triple_value']!= ''){
           $data .= '<span class="room_type_heading">Triple</span>';
         } 
         if($val['medina_room_type_double_value']!= ''){
          $data .= '<span class="room_type_heading">Double</span>';
        }
        $data .= '</li>
        <li>';
          if($val['medina_room_type_quad_value']!= ''){
            $data .= '<span class="hajj_room_type">$'.$val['medina_room_type_quad_value'].'</span>';
          } 
          if($val['medina_room_type_triple_value']!= ''){
           $data .= '<span class="hajj_room_type">$'.$val['medina_room_type_triple_value'].'</span>';
         } 
         if($val['medina_room_type_double_value']!= ''){
          $data .= '<span class="hajj_room_type">$'.$val['medina_room_type_double_value'].'</span>';
        }
        $data .= '</li>';
		   }
		   else if($_POST['medina_val'] && !$_POST['makkah_val'] && ($val['medina_room_type_quad_value']== '' || $val['medina_room_type_triple_value']== '' || $val['medina_room_type_double_value']== '')){}
		   else{
if($val['room_type_quad_value']!= '' || $val['room_type_triple_value']!= '' || $val['room_type_double_value']!= ''){
          $data .= '<li>';
          if($val['room_type_quad_value']!= ''){
            $data .=  '<span class="room_type_heading">Quad</span>';
          } 
          if($val['room_type_triple_value']!= ''){
           $data .= '<span class="room_type_heading">Triple</span>';
         } 
         if($val['room_type_double_value']!= ''){
          $data .= '<span class="room_type_heading">Double</span>';
        }
        $data .= '</li>
        <li>';
          if($val['room_type_quad_value']!= ''){
            $data .= '<span class="hajj_room_type">$'.$val['room_type_quad_value'].'</span>';
          } 
          if($val['room_type_triple_value']!= ''){
           $data .= '<span class="hajj_room_type">$'.$val['room_type_triple_value'].'</span>';
         } 
         if($val['room_type_double_value']!= ''){
          $data .= '<span class="hajj_room_type">$'.$val['room_type_double_value'].'</span>';
        }
        $data .= '</li>';
		   }
	}	   
     ...
     // $data .='<div class="col-md-2 col-sm-2 col-xs-2 col-lg-2 hajj_fourth_section"><span class="hajj_fourth_section_price">$'.$val['price'].'
