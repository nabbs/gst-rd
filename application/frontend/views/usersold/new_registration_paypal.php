...
<div class="income-content">
	  <div class="container">
		 ...
		 <div class="income-sidebar">
			<form id="new_registration_paypal" name="new_registration_paypal" method="post" action="<?php echo BASEURL; ?>/users/paypal_payment/">
			   <div class="col-sm-12">
			 ...
			 <div class="col-sm-12">
			  ...
			  <div class="form-group">
			   <input type="text" class="form-control" name="display_name"  placeholder="Create Your Username" />	  
			 </div>
			 </div>
			 <div class="col-sm-12">
			 <div class="form-group">
			...
			<!-- <div class="col-sm-12">
			 ...
			 <div class="col-sm-6">
			  <div class="form-group">
			   <input type="text" class="form-control" name="expiry_month" placeholder="Expiry Month" data-stripe="exp-month" />	  
			 </div>
			 </div>
			 <div class="col-sm-6">
			  <div class="form-group">
			   <input type="text" class="form-control" name="expiry_year" data-stripe="exp-year" placeholder="Expiry Year" />	  
			 </div>
			 </div>
			 <div class="col-sm-6">
			 ...
			 <div class="col-sm-12 ">
			  ...
			  <div class="form-group">
				...
				<label style="font-size: 13px; ">
					...
					<span class="cr" style="background-color:white;"><i class="cr-icon fa fa-check"></i></span>
		   ...
		   <div class="testimonials">	
			...
			<div class="col-sm-12">
			 <div class="media">
			  ...
			  <div class="media-body">				
				 <p>“I struggled for years in different home businesses. Now I'm earning more money that I ever have with the Easy Cash Code System. My residual income is already up to $3560 in 3 months. I'm so excited that I can't sleep lol. ” </p>			    <h4 class="media-heading">~ Jason Martinez</h4>
			  </div>
			 </div>			 	
			</div>
			<!--<div class="col-sm-12 patner" style="margin-top:15px">
