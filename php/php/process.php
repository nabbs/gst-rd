...
class SoapClientHMAC extends SoapClient {
  public function __doRequest($request, $location, $action, $version, $one_way = NULL) {
	global $context;
	$hmackey = "6tlXbmKobzf6EgarQaEr5BXt61smibPs"; // <-- Insert your HMAC key here
	$keyid = "422411"; // <-- Insert the Key ID here
	$hashtime = date("c");
...
$trxnProperties = array(
  ...
  "SurchargeAmount"=>$_POST["tbPOS_DollarAmount"],	//Used for debit transactions only
  "PAN"=>'FM9PS0999K'							//Used for debit transactions only
  );
